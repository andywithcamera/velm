...
func registerRoutes() {
	...
	http.Handle("/api/ai/connections", withAuth(authz.PermissionAdmin, http.HandlerFunc(handleAIConnections)))
	http.Handle("/api/ai/connections/{id}", withAuth(authz.PermissionAdmin, http.HandlerFunc(handleAIConnections)))
	http.Handle("/api/ai/connections/{id}/models/sync", withAuth(authz.PermissionAdmin, http.HandlerFunc(handleAIConnections)))
